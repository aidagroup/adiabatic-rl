...
#
# LF benchmark, 3000 iter/task, 2 wake phases / 1 sleep phase per task
#
...
gz sim ${sim_options} "${ROOT_PATH}/colored_line_following.sdf"  &
...
python3 -m gazebo_sim.ExperimentDQN                                                                                          \
        ...
        --task_list                                         circle_red circle_red circle_blue circle_green circle_yellow circle_yellow \
        --start_task                                        0                                                               \
        --eval_start_task                                   1                                                               \
